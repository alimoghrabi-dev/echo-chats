...
export class CommunityService {
  async getUsersQueriedService(req: Request, res: Response) {
    try {
  ...
  async sendFriendRequestService(req: Request, res: Response) {
    try {
  ...
  async acceptOrDenyFriendRequestService(req: Request, res: Response) {
    try {
      ...
      actions.push(
        FriendRequest.findByIdAndDelete(friendRequest._id),
        User.findByIdAndUpdate(user._id, {
